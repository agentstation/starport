...
// built-in monitoring, circuit breaking, and connection pooling.
//
...
//   - Middleware support for retry, rate limiting, etc.
...
//	config := httpclient.DefaultProviderConfig("openai")
//	client, err := httpclient.New("openai", config)
//
