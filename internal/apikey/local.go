...
// LocalOperatorKeyID names the API key of a request that carried a console
...
// LocalOperator returns the API key a console session runs as.
//
// It holds the wildcard scope, which the anonymous API key deliberately does
