				...
				Messages: []connectors.Message{
					{
						...
						Content: []any{
							...
							map[string]any{"type": "image_url", "image_url": map[string]any{"url": "http://example.com/image.jpg"}},
						},
					},
				},
			},
				...
				Messages: []connectors.Message{
					{
						Role: "user",
						Content: []any{
							map[string]any{"type": "image_url", "image_url": map[string]any{"url": "test.jpg"}},
						},
					},
				},
			},
