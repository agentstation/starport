// Package keys manages API keys for external LLM providers.
package byok
...
type ProviderKeys interface {
	...
	AddKey(ctx context.Context, scope, provider string, key map[string]string, config map[string]any, isFallback bool, priority int) (*models.ProviderKey, error)
	...
	UpdateKey(ctx context.Context, scope, provider string, key map[string]string, config map[string]any, isFallback *bool, priority *int) (*models.ProviderKey, error)
	...
	AddGlobalKey(ctx context.Context, provider string, key map[string]string, config map[string]any, rateLimit *models.RateLimitConfig) (*models.ProviderKey, error)
	GetGlobalKey(ctx context.Context, provider string) (*models.ProviderKey, error)
	UpdateGlobalKey(ctx context.Context, provider string, key map[string]string, config map[string]any, rateLimit *models.RateLimitConfig) (*models.ProviderKey, error)
