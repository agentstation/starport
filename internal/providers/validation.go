...
func (m *keyManager) ValidateKey(ctx context.Context, provider string, key map[string]string, config map[string]interface{}) error {
	switch provider {
	case "openai":
...
func (m *keyManager) validateOpenAI(ctx context.Context, key map[string]string, _ map[string]interface{}) error {
...
func (m *keyManager) validateAnthropic(ctx context.Context, key map[string]string, _ map[string]interface{}) error {
	apiKey, ok := key["api_key"]
	if !ok || apiKey == "" {
		return &ValidationError{
			Provider: "anthropic",
...
func (m *keyManager) validateAzureOpenAI(_ context.Context, key map[string]string, config map[string]interface{}) error {
	apiKey, ok := key["api_key"]
	if !ok || apiKey == "" {
		return &ValidationError{
			Provider: "azure",
...
func (m *keyManager) validateGoogleAIStudio(_ context.Context, key map[string]string, _ map[string]interface{}) error {
	apiKey, ok := key["api_key"]
	if !ok || apiKey == "" {
		return &ValidationError{
...
func (m *keyManager) validateAWSBedrock(_ context.Context, key map[string]string, _ map[string]interface{}) error {
...
func (m *keyManager) validateGroq(_ context.Context, key map[string]string, _ map[string]interface{}) error {
	apiKey, ok := key["api_key"]
	if !ok || apiKey == "" {
		return &ValidationError{
			Provider: "groq",
...
func (m *keyManager) validateMistral(_ context.Context, key map[string]string, _ map[string]interface{}) error {
	apiKey, ok := key["api_key"]
	if !ok || apiKey == "" {
		return &ValidationError{
			Provider: "mistral",
