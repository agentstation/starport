...
func TestChatHandler_Create(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			controller := controllers.NewChatController(tt.mockService())
...
func TestChatHandler_Streaming(t *testing.T) {
	...
	controller := controllers.NewChatController(mockService)
...
func TestChatHandler_StreamingCacheHeaders(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			controller := controllers.NewChatController(mockProxyInstance)
