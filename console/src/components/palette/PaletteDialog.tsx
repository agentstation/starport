...
// PaletteDialog is the global ⌘K surface over pages, actions, models,
// providers, authors, and keys, plus the last five destinations. The
// shell loads it on first open, so cmdk stays out of the entry chunk.
// Opening it starts the catalog queries, which share their cache keys
// with the pages. cmdk owns the combobox roles, the highlight, and the
// arrow keys; the palette index owns matching and ranking, so the fuzzy
// contract the pages use stays in one place.
