...
require_text DX-AUTH-3 'cloudchain\.DefaultCloudChains' internal/config/loader.go
require_text DX-AUTH-4 'providerauth\.ProductionRegistry' internal/providers/connectors/authentication.go
